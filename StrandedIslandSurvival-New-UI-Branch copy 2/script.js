...
function updateEnergyBar(energy) {
    const energyBar = document.getElementById('energy-bar');
    const energyValue = document.getElementById('energy-value');
    // Update the width of the energy bar and the displayed value
    //energyBar.style.width = `${energy}%`;
    energyValue.textContent = energy;

    // Change the color of the energy bar based on the energy level
    if (energy > 60) {
...
*/
// Example usage:
//updateEnergyBar(50); // Updates the energy bar to 50%
...
function choose(option) {
    ...
    switch (option) {
        ...
        case 'nextDay':
            setupNextDayPage();
            updateProgress(70);
            energyDisplay.style.width = randomNum4*3.2+100+"px";
            break;
        // If user wants to wave to get ship's attention
        case 'shipAttention':
            setupShipAttentionPage();
            updateProgress(80);
            energyDisplay.style.width = "100px";
            break;
...
function handleLocationSelect(location) {
    ...
    energyDisplay.style.width = currentEnergy*3.2+100+"px";
...
function setupBuildFirePage() {
    ...
    energyDisplay.style.width = energyAfterFire*3.2+100+"px";
